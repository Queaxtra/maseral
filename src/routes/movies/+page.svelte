<script lang="ts">
    ...
    import { listMovies, getMovieTrailer } from "$lib/movies";
...
<div class="mt-[60px] max-w-7xl mx-auto py-8 px-4">
    <div class="flex flex-col items-center text-center mb-12">
        <h1 class="text-4xl font-bold mb-4"><i class="ri-film-fill"></i> Explore Movies</h1>
        <p class="text-lg opacity-70 max-w-2xl">Discover the latest and greatest films from around the world. From blockbuster hits to indie gems, find your next favorite movie here.</p>
    </div>
